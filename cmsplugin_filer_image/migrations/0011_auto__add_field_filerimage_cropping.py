...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerImage.cropping'
        db.add_column('cmsplugin_filerimage', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerImage.cropping'
        db.delete_column('cmsplugin_filerimage', 'cropping')
